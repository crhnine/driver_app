...
<head>
	...
	<link href="layout/tablet.css" rel="stylesheet" type="text/css" />
    ...
    <div class="body_container" style="width:100%;margin-top:25px;">
        ...
        <div class="login_container" style="width:50%;margin:0 auto;">
            ...
            <form id="login_form" action="submissions/login_function.php" style="text-align:center" method="post">
                ...
                <button id="login_form_submit" class="login_form_submit" name="login_form_submit" type="submit" style="display:none">Login</button>
				<button id="login_form_sumbit_nonmobile" class="login_form_submit" name="login_form_submit" type="submit" style="display:none">Login</button>
            </form>
            ...
            <div id="footer_container" style="margin-top:100px;">
